...
item4.if_false = OnelineCode('222')

condition = "!!!!!!"
temp1 = IfBlockCode(condition)
temp1.if_true = OnelineCode('@@@@@@@@')
temp1.if_false = item4

condition = "aaaa"
temp = IfBlockCode(condition)
temp.if_true = OnelineCode('bbbb')
temp.if_false = temp1
...
itme6_tureBlock.add_line(
    OnelineCode('TYPE "Invalid testtypeStat, Looking for testtype_SC, testtype_TOR, testtype_FM, testtype_Sup"'))
itme6_tureBlock.add_line(OnelineCode('setstring remark1 "Unexpected value of testtype"'))
itme6_tureBlock.add_line(OnelineCode('call Insieme_Fail'))
